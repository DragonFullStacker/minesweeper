...
function VendorRegistration() {
  ...
  return (
    ...
    <div className = "flex flex-col ">
      ...
      <div className = "flex flex-row justify-between">
        <div className = "firstName flex flex-col firstName">
          <input type="text" name="firstName" id="firstname" autocomplete="username" className="input-field rounded " onClick = {(e) => setFirstName(e.target.value)}/>
          <label>First Name</label>
        </div>

        <div className = "lastName flex flex-col  lastName">
          <input type="text" name="lastName" id="lastname" autocomplete="username" className="input-field rounded" onClick = {(e) => setLastName(e.target.value)}/>
    ...
    <div className = "businessName flex flex-col">
      ...
      <div className = "flex flex-row justify-between"> 
        <div className = "flex flex-col bussName">
          <br></br>
          <input type = "text" name = "businessName" className="input-field rounded " onClick = {(e) => setBusinessName(e.target.value)}/>
        </div>
        ...
        <br></br>
          <input type = "text" name = "other" placeholder='Others' className = "rounded input-field" onClick = {(e) => setOthers(e.target.value)}/>
        </div>
    ...
    <div className = "email flex flex-col">
      ...
      <input type = "text" placeholder='ex: myname@example.com'  className = "rounded input-field" onClick = {(e) => setEmail(e.target.value)}/>
    </div>
    ...
    <div className = "other flex flex-col">
      <div className = "flex flex-row justify-between">
        <div className = "flex flex-col city">
          <label>City</label>
          <input type = "text"  className = "rounded input-field" onClick = {(e) => setCity(e.target.value)}/>
        </div>
        <div className = "flex flex-col state">
          <label>State / Province </label>
          <input type = "text"  className = "rounded input-field" onClick = {(e) => setState(e.target.value)}/>
        </div>
      </div>
      ...
      <div className = "flex flex-row justify-between">
        <div className = "flex flex-col city">
          ...
          <input type = "text" className = "rounded input-field" onClick = {(e) => setPostalCode(e.target.value)}/>
        </div>
        <div className = "state flex flex-col">
          <label> Country </label>
          <select className = "input-field rounded">
              <option value = "Please Select">Please Select</option>
          </select>
        </div>
      </div>
