...
function VendorRegistration() {
  ...
  return (
    ...
    <div className = "register flex flex-col text-base justify-start">
      ...
      <div className = "flex flex-row justify-between">
        ...
        <div className = "state flex flex-col">
          ...
          <select className = "input-field rounded" onChange = {(e) => {console.log(e.target.value)}}>
              <option value = "Please Select">Please Select1</option>
              <option value = "Please Select">Please Select2</option>
              <option value = "Please Select">Please Select3</option>
          </select>
        </div>
      </div>
    </div>
