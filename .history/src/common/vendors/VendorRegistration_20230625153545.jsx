...
function VendorRegistration() {
  return (
    ...
    <div className = "text-base register">
 
    <h1>Register Your Business</h1>
    <h2>Please provide all required details to register your business with us.</h2>
    <hr></hr>
      <div className = "Business Owner flex flex-col ">
        <h2 className = "bold">Business Owner *</h2>
        <div className = "flex flex-row justify-between">
          <div className = "firstName flex flex-col firstName">
            <input type="text" name="firstName" id="username" autocomplete="username" className="input-field inputField rounded "/>
