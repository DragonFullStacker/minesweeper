  ...
  return (
    <div className = "listcontainer flex flex-col text-base justify-center">
      ...
      <div className = "flex flex-row step align-middle">
        <button className = "bg-btn w-1/2 about  text-base" onClick = {() => console.log('aaaa')}>Step 1: About Product</button>
        <button className = "bg-btn w-1/2  text-base">Step 2: Product Details</button>
      </div>
